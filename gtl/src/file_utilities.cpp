...
namespace file {
    ...
    R get_file_blob_helper(std::string const& full_path_filename)
    {
    ...
    std::vector<char> get_file_blob(std::string const& full_path_filename) 
    {
        return get_file_blob_helper<std::vector<char>>(full_path_filename);    
    }    

    std::vector<char, gtl::allocators::no_trivial_init<char>>
    get_file_blob(gtl::tags::no_initialization, std::string const& full_path_filename)
    {
