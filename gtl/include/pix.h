...
/*-----------------------------------------------------------------------------
    ...
    Tools for pixels: displays-independent-pixels, screen pixels, pixels per inch,
    and so on..
...
namespace pix {        
    ...
    inline namespace pix_units_v0 {
        ...
        struct em     : detail::value_base<int> { using detail::value_base<int>::value_base; };
        struct px     : detail::value_base<int> { using detail::value_base<int>::value_base; };
        struct pt     : detail::value_base<int> { using detail::value_base<int>::value_base; };
        struct ppi    : detail::value_base<int> { using detail::value_base<int>::value_base; };
        struct lpx    : detail::value_base<int> { using detail::value_base<int>::value_base; };        
        struct inches : detail::value_base<int> { using detail::value_base<int>::value_base; };        
        ...
        template <typename T, typename ...Args> T convert_to(Args...); 
