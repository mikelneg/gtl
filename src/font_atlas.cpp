...
namespace d3d {
    ...
    static std::array<Eigen::Vector4f, 5> uv_for_character(font_atlas_glyph& f, uint8_t c)
    {
        std::array<Eigen::Vector4f, 5> arr;

        Glyph& g = f.glyph_map.at(c);

        arr[0] = Eigen::Vector4f{g.u, g.v, g.u, g.v + g.height};
        arr[1] = Eigen::Vector4f{g.u + g.width, g.v, g.u + g.width, g.v + g.height};
    ...
    static std::array<Eigen::Vector4f, 9> character_info(font_atlas_glyph& f, uint8_t c)
    {
    ...
    void font_atlas::construct_vertices(std::string const& message) const
    {
        ...
        //   <font>
        // <info face="font" size="24" bold="1" italic="0" charset="" unicode="" stretchH="100" smooth="1" aa="1"
        // padding="5,5,5,5" spacing="0,0" outline="0"/>
        ...
        //   <char id="98" x="5" y="28" width="17" height="22" xoffset="3" yoffset="0" xadvance="15" page="0"
        //   chnl="15"/>
        //   <char id="99" x="5" y="55" width="16" height="18" xoffset="2" yoffset="5" xadvance="13" page="0"
        //   chnl="15"/>
        //   <char id="100" x="5" y="78" width="17" height="22" xoffset="2" yoffset="0" xadvance="15" page="0"
        //   chnl="15"/>
        //   <char id="101" x="26" y="55" width="16" height="18" xoffset="2" yoffset="5" xadvance="13" page="0"
        //   chnl="15"/>
        //   <char id="102" x="27" y="5" width="12" height="22" xoffset="1" yoffset="0" xadvance="8" page="0"
        //   chnl="15"/>
        //   <char id="103" x="44" y="5" width="17" height="22" xoffset="2" yoffset="5" xadvance="15" page="0"
        //   chnl="15"/>
        //   <char id="104" x="5" y="105" width="16" height="22" xoffset="3" yoffset="0" xadvance="15" page="0"
        //   chnl="15"/>
        //   <char id="105" x="5" y="132" width="8" height="22" xoffset="3" yoffset="0" xadvance="7" page="0"
        //   chnl="15"/>
        //   <char id="106" x="5" y="159" width="10" height="27" xoffset="1" yoffset="0" xadvance="7" page="0"
        //   chnl="15"/>
        //   <char id="107" x="18" y="132" width="16" height="22" xoffset="3" yoffset="0" xadvance="13" page="0"
        //   chnl="15"/>
        //   <char id="108" x="26" y="105" width="8" height="22" xoffset="3" yoffset="0" xadvance="7" page="0"
        //   chnl="15"/>
        //   <char id="109" x="27" y="32" width="23" height="17" xoffset="3" yoffset="5" xadvance="21" page="0"
        //   chnl="15"/>
