...
namespace file {
    ...
    static inline R
    get_file_blob_helper(S const& full_path_filename)
    {
    ...
    std::vector<char>
    get_file_blob(std::string full_path_filename)
    {
    ...
    get_file_blob(gtl::tags::no_initialization, std::string full_path_filename)
    {
        return get_file_blob_helper<std::vector<char,
                                                gtl::allocators::no_trivial_init<char>>>(full_path_filename);
    }

    std::vector<char>
    get_file_blob(std::wstring full_path_filename)
    {
        return get_file_blob_helper<std::vector<char>>(full_path_filename);
    }
