...
namespace pix {
    ...
    inline namespace pix_units_v0 {
        em operator"" _em(unsigned long long int v) { return em{ static_cast<em::type>(v) }; }
        px operator"" _px(unsigned long long int v) { return px{ static_cast<px::type>(v) }; }
        pt operator"" _pt(unsigned long long int v) { return pt{ static_cast<pt::type>(v) }; }
        lpx operator"" _lpx(unsigned long long int v) { return lpx{ static_cast<lpx::type>(v) }; }
        ppi operator"" _ppi(unsigned long long int v) { return ppi{ static_cast<ppi::type>(v) }; }
        inches operator"" _inches(long double v) { return inches{ static_cast<inches::type>(v) }; }
        inches operator"" _inches(unsigned long long int v) { return inches{ static_cast<inches::type>(v) }; }
        double operator"" _to_1(long double v) { return static_cast<double>(v / 1); }
