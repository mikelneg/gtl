...
namespace mesh {    
    ...
    struct bone {
        ...
        static constexpr int root_id() { return -1; }        
        ...
        bone(Eigen::Matrix4f const& t, 
             Eigen::Vector4f const& tail_position, 
             id_type parent_id)
            : transform_(t), 
              tail_(tail_position), 
        ...
        void add_child(id_type child_id) { children_ids_.emplace_back(child_id); }
