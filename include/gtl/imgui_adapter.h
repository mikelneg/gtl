...
namespace gtl {
    ...
    public:
        ...
        struct imgui_data {
            ...
            void swap(imgui_data& other) { using std::swap; swap(vertices_,other.vertices_); swap(indices_,other.indices_); }
        };
    ...
    public:
        ...
        void dump_data(ImDrawData& draw_data) {
            ...
            if (verts.size() < draw_data.TotalVtxCount) verts.resize(draw_data.TotalVtxCount); 
            if (indices.size() < draw_data.TotalIdxCount) indices.resize(draw_data.TotalIdxCount); 
