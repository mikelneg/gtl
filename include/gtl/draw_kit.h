...
namespace gtl {
    ...
    public:
        ...
        decltype(auto) vertices() { return vertices_; }
        decltype(auto) indices() { return indices_; }
        ...
        //    const float line_width = 0.06f;    
            ...
            const Eigen::Vector3f pts[]{{0.0f, line_width, 0.0f},
                                        {len,  line_width, 0.0f},
                                        {len, -line_width, 0.0f},
                                        {0.0f,-line_width, 0.0f},                                        
                                        {0.0f, 0.0f, line_width},
                                        {len,  0.0f, line_width},
                                        {len,  0.0f,-line_width},
                                        {0.0f, 0.0f,-line_width}};
    
    
            const index_type indices[]{0,1,2,0,2,3,
                                       4,5,6,4,6,7}; 
            ...
            add_triangle(0,1,2); add_triangle(0,2,3); 
            add_triangle(4,5,6); add_triangle(4,6,7);
            next_group();
